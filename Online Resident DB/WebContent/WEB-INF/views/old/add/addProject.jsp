...
<hr>
Enter details of a new project. The name and client fields are obligatory.
<hr>
...
<table class="bordless">
	...
	<tr>
		<td>Client</td>
		<td colspan="2">
			<input id="client" class="text" name="client" maxlength="45" />
			<span id="errorClient" class="error"></span>
		</td>
	</tr>
	<tr>
		<td></td>
		<td><input class="submit" type="submit" name="addProject" value="Submit" /></td>
	</tr>
</table>
</form>
