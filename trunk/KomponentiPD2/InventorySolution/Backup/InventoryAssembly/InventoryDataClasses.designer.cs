...
namespace InventoryAssembly
{
    ...
    partial void DeleteUser(User instance);
		...
		public InventoryDataClassesDataContext() : 
				base(global::InventoryAssembly.Properties.Settings.Default.InventoryConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	[Table(Name="dbo.INVENTORY_TABLE")]
    ...
    partial void OnRESERVEDChanged();
		...
		[Column(Storage="_ID", DbType="Char(20) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string ID
		{
			get
			{
		...
		[Column(Storage="_DESCRIPTION", DbType="NChar(40)")]
		...
		[Column(Storage="_INSTOCK", DbType="Int")]
		...
		[Column(Storage="_RESERVED", DbType="Int")]
    ...
    partial void OnLAST_NAMEChanged();
		...
		[Column(Storage="_FIRST_NAME", DbType="Char(40)")]
		...
		[Column(Storage="_LAST_NAME", DbType="Char(40)")]
